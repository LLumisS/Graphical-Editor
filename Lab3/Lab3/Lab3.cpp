    ...
    case WM_COMMAND:
        {
            ...
            {
            case ID_TOOL_POINT:
                cyrille.StartPointEditor(hWnd, &cirillius);
                break;
            case ID_TOOL_LINE:
                cyrille.StartLineEditor(hWnd, &cirillius);
                break;
            case ID_TOOL_RECT:
                cyrille.StartRectEditor(hWnd, &cirillius);
                break;
            case ID_TOOL_ELLIPSE:
                cyrille.StartEllipseEditor(hWnd, &cirillius);
                break;
